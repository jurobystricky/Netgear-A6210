...
BOOLEAN Set_ATE_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);

BOOLEAN	Set_ATE_DA_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);
...
BOOLEAN Set_ADCDump_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);

#if defined(RTMP_BOOLEANERNAL_TX_ALC) || defined(RTMP_TEMPERATURE_COMPENSATION)
BOOLEAN Set_ATE_TSSI_CALIBRATION_EX_Proc(
	IN      PRTMP_ADAPTER   pAd,
	IN      PSTRING                 arg);
#endif /* defined(RTMP_BOOLEANERNAL_TX_ALC) || defined(RTMP_TEMPERATURE_COMPENSATION) */

#ifdef RTMP_BOOLEANERNAL_TX_ALC
BOOLEAN Set_ATE_TSSI_CALIBRATION_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);
...
BOOLEAN Set_ATE_READ_EXTERNAL_TSSI_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);
#endif /* RTMP_TEMPERATURE_COMPENSATION */

BOOLEAN	Set_ATE_TX_POWER0_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);

BOOLEAN	Set_ATE_TX_POWER1_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);

#ifdef DOT11N_SS3_SUPPORT
BOOLEAN	Set_ATE_TX_POWER2_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);
#endif /* DOT11N_SS3_SUPPORT */

BOOLEAN	Set_ATE_TX_POWER_EVALUATION_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);

BOOLEAN	Set_ATE_TX_Antenna_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);

BOOLEAN	Set_ATE_RX_Antenna_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);
...
VOID ATEAsicExtraPowerOverMAC(
	IN	PRTMP_ADAPTER	pAd);
#ifdef RT3350
BOOLEAN	Set_ATE_PA_Bias_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);
#endif /* RT3350 */

BOOLEAN	Default_Set_ATE_TX_FREQ_OFFSET_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);

#if defined(RT28xx) || defined(RT2880)
BOOLEAN	RT28xx_Set_ATE_TX_FREQ_OFFSET_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);
#endif /* defined(RT28xx) || defined(RT2880) */


BOOLEAN	Set_ATE_TX_FREQ_OFFSET_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);

BOOLEAN	Default_Set_ATE_TX_BW_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);

#if defined(RT28xx) || defined(RT2880)
BOOLEAN	RT28xx_Set_ATE_TX_BW_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);
#endif /* defined(RT28xx) || defined(RT2880) */

BOOLEAN	Set_ATE_TX_BW_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);

BOOLEAN	Set_ATE_TX_LENGTH_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);

BOOLEAN	Set_ATE_TX_COUNT_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);
...
BOOLEAN	Set_ATE_RX_FER_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);

BOOLEAN Set_ATE_Read_RF_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);

#if (!defined(RTMP_RF_RW_SUPPORT)) && (!defined(RLT_RF))
BOOLEAN Set_ATE_Write_RF1_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);

BOOLEAN Set_ATE_Write_RF2_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);

BOOLEAN Set_ATE_Write_RF3_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);

BOOLEAN Set_ATE_Write_RF4_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);
#endif /* (!defined(RTMP_RF_RW_SUPPORT)) && (!defined(RLT_RF)) */

BOOLEAN Set_ATE_Load_E2P_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);

#ifdef RTMP_EFUSE_SUPPORT
BOOLEAN Set_ATE_Load_E2P_From_Buf_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);
#endif /* RTMP_EFUSE_SUPPORT */

BOOLEAN Set_ATE_Read_E2P_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);

BOOLEAN	Set_ATE_AUTO_ALC_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);

BOOLEAN	Set_ATE_TEMP_SENSOR_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);

BOOLEAN Set_ATE_SINGLE_SKU_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING 		arg);

BOOLEAN	Set_ATE_IPG_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);

BOOLEAN Set_ATE_Payload_Proc(
	IN  PRTMP_ADAPTER   pAd,
	IN  PSTRING         arg);

BOOLEAN Set_ATE_Fixed_Payload_Proc(
	IN  PRTMP_ADAPTER   pAd,
	IN  PSTRING         arg);

#ifdef TXBF_SUPPORT
BOOLEAN	Set_ATE_TXBF_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);

BOOLEAN	Set_ATE_TXSOUNDING_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);

BOOLEAN	Set_ATE_TXBF_DIVCAL_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);

BOOLEAN	Set_ATE_TXBF_LNACAL_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);

BOOLEAN Set_ATE_TXBF_INIT_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);

BOOLEAN Set_ATE_TXBF_CAL_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);

#ifdef MT76x2
BOOLEAN Set_ATE_TXBF_New_CAL_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);

BOOLEAN Set_ATE_New_Phase_Verify(
	IN	PRTMP_ADAPTER	pAd,
	IN  PSTRING         arg);
#endif

BOOLEAN Set_ATE_TXBF_GOLDEN_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);

BOOLEAN Set_ATE_TXBF_VERIFY_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);

BOOLEAN Set_ATE_TXBF_VERIFY_NoComp_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);

BOOLEAN Set_ATE_ForceBBP_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);
#endif /* TXBF_SUPPORT */


BOOLEAN	Set_ATE_Show_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);

BOOLEAN	Set_ATE_Help_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);
...
#ifdef MT76x2
BOOLEAN Set_ATE_DO_CALIBRATION_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);

BOOLEAN Set_ATE_Load_CR_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			arg);
#endif /* MT76x2 */
