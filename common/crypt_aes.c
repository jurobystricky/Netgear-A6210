...
========================================================================
*/
static void RT_AES_KeyExpansion (UINT8 Key[], UINT KeyLength, AES_CTX_STRUC *paes_ctx)
{
	UINT KeyIndex = 0;
...
========================================================================
*/
static void RT_AES_Encrypt (UINT8 PlainBlock[], UINT PlainBlockSize, UINT8 Key[],
...
========================================================================
*/
static void RT_AES_Decrypt (UINT8 CipherBlock[], UINT CipherBlockSize, UINT8 Key[],
...
========================================================================
*/
static void AES_CCM_MAC (UINT8 Payload[], UINT PayloadLength, UINT8 Key[],
...
int AES_CCM_Encrypt (UINT8 PlainText[], UINT PlainTextLength, UINT8 Key[],
	UINT KeyLength, UINT8 Nonce[], UINT NonceLength, UINT8 AAD[], UINT AADLength,
	UINT MACLength, UINT8 CipherText[], UINT *CipherTextLength)
{
...
========================================================================
*/
int AES_CCM_Decrypt (IN UINT8 CipherText[], UINT CipherTextLength,
	UINT8 Key[], UINT KeyLength, UINT8 Nonce[], UINT NonceLength, UINT8 AAD[],
	UINT AADLength, UINT MACLength, UINT8 PlainText[], UINT *PlainTextLength)
{
...
========================================================================
*/
static void AES_CMAC_GenerateSubKey (UINT8 Key[], UINT KeyLength, UINT8 SubKey1[],
	UINT8 SubKey2[])
{
...
*/
#if 0 //JB removed
static void AES_CBC_Encrypt (UINT8 PlainText[], UINT PlainTextLength, UINT8 Key[],
	UINT KeyLength, UINT8 IV[], UINT IVLength, UINT8 CipherText[],
...
*/
#if 0 //JB removed
static void AES_CBC_Decrypt (UINT8 CipherText[], UINT CipherTextLength,
	UINT8 Key[], UINT KeyLength, UINT8 IV[], UINT IVLength, UINT8 PlainText[],
