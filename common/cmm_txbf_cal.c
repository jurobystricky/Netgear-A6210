...
#ifdef MT76x2
static VOID CalcDividerPhase(PRTMP_ADAPTER pAd, UCHAR *mPhase0)
{
	int i;
...
#ifdef MT76x2
static BOOLEAN mt76x2_ITxBFDividerCalibration(RTMP_ADAPTER *pAd, int calFunction,
	int calMethod, UCHAR *divPhase)
{
...
#ifdef MT76x2
BOOLEAN ITxBFPhaseCalibrationStartUp(RTMP_ADAPTER *pAd, INT calFunction, USHORT ch)
{
	UINT32 CR_BK[35];
...
BOOLEAN TxBfProfileDataRead(PRTMP_ADAPTER pAd, PFMU_DATA *pData, UCHAR profileIdx, UCHAR subcarrierIdx)
{
	UINT value32, readValue32[5];
...
BOOLEAN TxBfProfileDataWrite(PRTMP_ADAPTER pAd, PFMU_DATA *pData, UCHAR profileIdx, UCHAR subcarrierIdx)
{
	UINT value32, readValue32[5];
...
static INT32 ei0[PROFILE_MAX_CARRIERS_40][2];
static INT32 ei1[PROFILE_MAX_CARRIERS_40][2];
//JB removed static INT32 ei2[PROFILE_MAX_CARRIERS_40][2];
