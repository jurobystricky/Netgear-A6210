...
static UINT Tkip_Sbox_Lower[256] =
{
...
static UINT Tkip_Sbox_Upper[256] =
{
...
/*
	...
	========================================================================
*/
static ULONG RTMPTkipGetUInt32(PUCHAR pMICKey)
{
	ULONG res = 0;
	int i;
...
/*
	...
	========================================================================
*/
static void RTMPTkipPutUInt32(PUCHAR pDst, ULONG val)
{
	int i;
...
/*
	...
	========================================================================
*/
static void RTMPTkipSetMICKey(PTKIP_KEY_INFO pTkip, PUCHAR pMICKey)
{
	/* Set the key */
...
/*
	...
	========================================================================
*/
static void RTMPTkipAppendByte(PTKIP_KEY_INFO pTkip, UCHAR uChar)
{
...
/*
	...
	========================================================================
*/
static void RTMPTkipGetMIC(PTKIP_KEY_INFO pTkip)
{
...
/*
	...
	========================================================================
*/
static void RTMPInitMICEngine(PRTMP_ADAPTER pAd, PUCHAR pKey, PUCHAR pDA,
	PUCHAR pSA, UCHAR UserPriority, PUCHAR pMICKey)
{
...
/*
	...
	========================================================================
*/
BOOLEAN RTMPTkipCompareMICValue(PRTMP_ADAPTER pAd, PUCHAR pSrc, PUCHAR pDA,
...
/*
	...
	========================================================================
*/
void RTMPCalculateMICValue(PRTMP_ADAPTER pAd, PNDIS_PACKET pPacket, PUCHAR pEncap,
	PCIPHER_KEY pKey, UCHAR apidx)
{
	...
	if (apidx >= MIN_NET_DEVICE_FOR_APCLI &&
		...
		/*
		 * For packet which need to do MATConvert, we need to use
		 * the CurrentAddress of specific ApCli interface.
		 */
		RTMPInitMICEngine(pAd, pKey->Key, pSrc,
	...
	{
		RTMPInitMICEngine(pAd, pKey->Key, pSrc, pSrc + 6, UserPriority,
			pKey->TxMic);
	}
...
{
	UINT tsc0, tsc1, tsc2;
	UINT ppk0, ppk1, ppk2, ppk3, ppk4, ppk5;
	int i, j;
...
NDIS_STATUS RTMPSoftDecryptTKIP(PRTMP_ADAPTER pAd, PUCHAR pHdr, UCHAR UserPriority,
	PCIPHER_KEY pKey, PUCHAR pData, UINT16 *DataByteCnt)
{
	PHEADER_802_11 pFrame;
	UINT8 frame_type, frame_subtype, from_ds, to_ds, a4_exists, qc_exists;
	UCHAR TA[MAC_ADDR_LEN], DA[MAC_ADDR_LEN], SA[MAC_ADDR_LEN], RC4Key[16];
...
/*
	...
	========================================================================
*/
void TKIP_GTK_KEY_WRAP(UCHAR *key,UCHAR *iv, UCHAR *input_text, UINT32 input_len,
	UCHAR *output_text)
{
	...
	/* allocate memory */
	pARC4_CTX = os_alloc_mem(sizeof(ARC4_CTX_STRUC));
	if (pARC4_CTX == NULL) {
		return;
	}
...
void TKIP_GTK_KEY_UNWRAP(UCHAR *key, UCHAR *iv, UCHAR *input_text,
	UINT32 input_len, UCHAR *output_text)
{
