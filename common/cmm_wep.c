...
/*
	...
	========================================================================
*/
static void RTMPInitWepEngine(PUCHAR pIv, PUCHAR pKey, UCHAR KeyLen,
	ARC4_CTX_STRUC *pARC4_CTX)
{
	PUCHAR	seed = NULL;
	UINT8	seed_len;

	seed = os_alloc_mem(sizeof(UCHAR)*16);
	if (seed == NULL) {
		return;
	}
	...
	PUCHAR pData, ULONG DataByteCnt)
{
	...
	ARC4_CTX = os_alloc_mem(sizeof(ARC4_CTX_STRUC));
	if (ARC4_CTX == NULL) {
		return FALSE;
	}
