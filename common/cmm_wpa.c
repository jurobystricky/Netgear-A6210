...
/*
	...
	==========================================================================
 */
static BOOLEAN PeerWpaMessageSanity(
		PRTMP_ADAPTER 		pAd,
		PEAPOL_PACKET 		pMsg,
		ULONG 				MsgLen,
		UCHAR				MsgType,
...
/*
	...
	========================================================================
*/
static VOID PeerPairMsg1Action(
	PRTMP_ADAPTER    pAd,
	MAC_TABLE_ENTRY  *pEntry,
	MLME_QUEUE_ELEM  *Elem)
{
...
/*
	...
	==========================================================================
*/
static VOID PeerPairMsg2Action(
	PRTMP_ADAPTER    pAd,
	MAC_TABLE_ENTRY  *pEntry,
	MLME_QUEUE_ELEM  *Elem)
{
...
/*
	...
	========================================================================
*/
static VOID PeerPairMsg3Action(
	PRTMP_ADAPTER    pAd,
	MAC_TABLE_ENTRY  *pEntry,
	MLME_QUEUE_ELEM  *Elem)
{
...
/*
	...
	==========================================================================
*/
static VOID PeerPairMsg4Action(
	PRTMP_ADAPTER    pAd,
	MAC_TABLE_ENTRY  *pEntry,
	MLME_QUEUE_ELEM  *Elem)
{
