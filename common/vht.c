...
#if 0 //JB removed
static VOID dump_vht_op(RTMP_ADAPTER *pAd, VHT_OP_IE *vht_ie)
{
#ifdef DBG
...
BOOLEAN vht_mode_adjust(RTMP_ADAPTER *pAd, MAC_TABLE_ENTRY *pEntry, 
...
BOOLEAN get_vht_op_ch_width(RTMP_ADAPTER *pAd)
{
	return TRUE;
}
