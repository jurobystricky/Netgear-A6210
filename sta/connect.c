...
/*
	...
	==========================================================================
*/
VOID CntlIdleProc(PRTMP_ADAPTER pAd, MLME_QUEUE_ELEM *Elem)
{
...
/*
	...
	==========================================================================
*/
VOID CntlOidSsidProc(PRTMP_ADAPTER pAd, MLME_QUEUE_ELEM *Elem)
{
...
/* */
/* IRQL = DISPATCH_LEVEL */
VOID CntlMlmeRoamingProc(PRTMP_ADAPTER pAd, MLME_QUEUE_ELEM *Elem)
{
...
/*
	...
	==========================================================================
*/
VOID CntlWaitJoinProc(PRTMP_ADAPTER pAd, MLME_QUEUE_ELEM *Elem)
{
	USHORT Reason;
...
/*
	...
	==========================================================================
*/
VOID CntlWaitAuthProc(PRTMP_ADAPTER pAd, MLME_QUEUE_ELEM *Elem)
{
	USHORT Reason;
...
/*
	...
	==========================================================================
*/
VOID CntlWaitAuthProc2(PRTMP_ADAPTER pAd, MLME_QUEUE_ELEM *Elem)
{
	USHORT Reason;
	MLME_ASSOC_REQ_STRUCT AssocReq;
	MLME_AUTH_REQ_STRUCT AuthReq;
...
/*
	...
	==========================================================================
*/
VOID CntlWaitAssocProc(PRTMP_ADAPTER pAd, MLME_QUEUE_ELEM *Elem)
{
	USHORT Reason;
...
/*
	...
	==========================================================================
*/
VOID CntlWaitReassocProc(PRTMP_ADAPTER pAd, MLME_QUEUE_ELEM *Elem)
{
	USHORT Result;
