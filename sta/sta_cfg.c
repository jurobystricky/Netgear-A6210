...
BOOLEAN Set_AutoReconnect_Proc(
	IN  PRTMP_ADAPTER	pAd,
	IN  PSTRING			arg);

BOOLEAN Set_AdhocN_Proc(
	IN  PRTMP_ADAPTER	pAd,
	IN  PSTRING			arg);
...
/*
	...
	==========================================================================
*/
BOOLEAN Set_AuthMode_Proc(IN PRTMP_ADAPTER pAd, IN PSTRING arg)
{
...
/*
	...
	==========================================================================
*/
BOOLEAN Set_DefaultKeyID_Proc(IN PRTMP_ADAPTER pAdapter, IN  PSTRING arg)
{
	ULONG KeyIdx;
...
BOOLEAN Show_Adhoc_MacTable_Proc(
	IN	PRTMP_ADAPTER	pAd,
	IN	PSTRING			extra,
	IN	UINT32			size)
{
...
BOOLEAN Set_BeaconLostTime_Proc(
	IN  PRTMP_ADAPTER   pAd,
	IN  PSTRING         arg)
{
	...
	IN  INT                 cmd)
{
	...
	case RT_OID_802_11_QUERY_TXBF_TABLE:
		...
		case RT_OID_802_11_QUERY_LAST_TX_RATE:
			...
			DBGPRINT(RT_DEBUG_TRACE, ("Query::RT_OID_802_11_QUERY_LAST_RX_RATE (=%lu)\n", RateValue));
			break;
		case RT_OID_802_11_QUERY_MAP_REAL_TX_RATE:
			...
			wrq->u.data.length = sizeof(RateValue);
			Status = copy_to_user(wrq->u.data.pointer, &RateValue, wrq->u.data.length);
			DBGPRINT(RT_DEBUG_TRACE, ("Query::RT_OID_802_11_QUERY_LAST_TX_RATE (=%lu)\n", RateValue));
			break;
