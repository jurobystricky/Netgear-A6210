...
/***************************************************************************
  ...
  **************************************************************************/
static inline VOID ConvertMulticastIP2MAC(PUCHAR pIpAddr, PUCHAR *ppMacAddr,
	UINT16 ProtoType)
{
	if (pIpAddr == NULL)
		return;
...
VOID RTMP_ReadRF(RTMP_ADAPTER *pAd, UCHAR RegID, PUCHAR pValue1, PUCHAR pValue2,
	UCHAR BitMask);
...
//JBb removedVOID AsicForceSleep(RTMP_ADAPTER *pAd);
...
//JB removedBOOLEAN AsicSetGPTimer(RTMP_ADAPTER *pAd, BOOLEAN enable, UINT32 timeout);
...
//JB removed BOOLEAN AsicAutoFallbackInit(RTMP_ADAPTER *pAd);
...
VOID UpdateBasicRateBitmap(RTMP_ADAPTER *pAd);
...
#ifdef MICROWAVE_OVEN_SUPPORT
BOOLEAN Set_MO_FalseCCATh_Proc(
	IN RTMP_ADAPTER *pAd,
	IN PSTRING arg);
...
#ifdef RTMP_EFUSE_SUPPORT
BOOLEAN set_eFuseGetFreeBlockCount_Proc(
   	IN PRTMP_ADAPTER pAd,
	IN PSTRING arg);

BOOLEAN set_eFusedump_Proc(
	IN PRTMP_ADAPTER pAd,
	IN PSTRING arg);

BOOLEAN set_eFuseLoadFromBin_Proc(
	IN PRTMP_ADAPTER pAd,
	IN PSTRING arg);
...
#ifdef RALINK_ATE
BOOLEAN Set_LoadEepromBufferFromEfuse_Proc(
	IN PRTMP_ADAPTER pAd,
	IN PSTRING arg);

BOOLEAN set_eFuseBufferModeWriteBack_Proc(
	IN PRTMP_ADAPTER pAd,
	IN PSTRING arg);

BOOLEAN set_BinModeWriteBack_Proc(
	IN PRTMP_ADAPTER pAd,
	IN PSTRING arg);
...
#ifdef MULTI_MAC_ADDR_EXT_SUPPORT
BOOLEAN Set_EnMultiMacAddrExt_Proc(
	IN RTMP_ADAPTER	*pAd,
	IN PSTRING arg);

BOOLEAN Set_MultiMacAddrExt_Proc(
	IN	RTMP_ADAPTER *pAd,
	IN	PSTRING arg);
#endif /* MULTI_MAC_ADDR_EXT_SUPPORT */
...
#ifdef MT76x2
BOOLEAN Set_TxBfProfileTag_Help(
	IN  PRTMP_ADAPTER   pAd,
	IN  PSTRING         arg);

BOOLEAN Set_TxBfProfileTagValid(
	IN  PRTMP_ADAPTER   pAd,
	IN  PSTRING         arg);

BOOLEAN Set_TxBfProfileTagRead(
	IN  PRTMP_ADAPTER   pAd,
	IN  PSTRING         arg);

BOOLEAN Set_TxBfProfileTagWrite(
	IN  PRTMP_ADAPTER   pAd,
	IN  PSTRING         arg);

BOOLEAN Set_TxBfProfileDataRead(
	IN PRTMP_ADAPTER    pAd,
	IN PSTRING          arg);

BOOLEAN Set_TxBfProfileDataWrite(
	IN PRTMP_ADAPTER    pAd,
	IN PSTRING          arg);

BOOLEAN Set_TxBfProfileDataWriteAll(
	IN PRTMP_ADAPTER    pAd,
	IN PSTRING          arg);

BOOLEAN Set_TxBfProfileDataReadAll(
	IN PRTMP_ADAPTER    pAd,
	IN PSTRING          arg);

BOOLEAN Set_TxBfProfileTag_TimeOut(
	IN PRTMP_ADAPTER    pAd,
	IN PSTRING          arg);

BOOLEAN Set_TxBfProfileTag_Matrix(
	IN PRTMP_ADAPTER    pAd,
	IN PSTRING          arg);

BOOLEAN Set_TxBfProfileTag_SNR(
	IN PRTMP_ADAPTER   pAd,
	IN PSTRING         arg);


BOOLEAN Set_TxBfProfileTag_TxScale(
	IN PRTMP_ADAPTER   pAd,
	IN PSTRING         arg);

BOOLEAN Set_TxBfProfileTag_MAC(
	IN PRTMP_ADAPTER   pAd,
	IN PSTRING         arg);

BOOLEAN Set_TxBfProfileTag_Flg(
	IN PRTMP_ADAPTER   pAd,
	IN PSTRING         arg);
#endif
...
BOOLEAN	Set_VhtDisallowNonVHT_Proc(
	IN RTMP_ADAPTER *pAd,
	IN PSTRING arg);
#endif /* DOT11_VHT_AC */
...
BOOLEAN Set_ApCli_Enable_Proc(IN PRTMP_ADAPTER pAd, IN PSTRING arg);
BOOLEAN Set_ApCli_Ssid_Proc(IN PRTMP_ADAPTER pAd, IN PSTRING arg);
#endif /* APCLI_SUPPORT */
#endif /* CONFIG_AP_SUPPORT */
...
BOOLEAN Set_WmmCapable_Proc(RTMP_ADAPTER *pAd, PSTRING arg);
...
BOOLEAN Set_DefaultKeyID_Proc(RTMP_ADAPTER *pAd, PSTRING arg);
BOOLEAN Set_Wep_Key_Proc(RTMP_ADAPTER  *pAd, PSTRING Key, INT KeyLen, INT KeyId);
BOOLEAN Set_Key1_Proc(RTMP_ADAPTER *pAd, PSTRING arg);
BOOLEAN Set_Key2_Proc(RTMP_ADAPTER *pAd, PSTRING arg);
BOOLEAN Set_Key3_Proc(RTMP_ADAPTER *pAd, PSTRING arg);
BOOLEAN Set_Key4_Proc(RTMP_ADAPTER *pAd, PSTRING arg);
BOOLEAN Set_WPAPSK_Proc(RTMP_ADAPTER *pAd, PSTRING arg);
BOOLEAN Set_PSMode_Proc(RTMP_ADAPTER *pAd, PSTRING arg);
...
#ifdef DOT11_N_SUPPORT
BOOLEAN Set_TGnWifiTest_Proc(RTMP_ADAPTER *pAd, PSTRING arg);
#endif /* DOT11_N_SUPPORT */
...
#ifdef EXT_BUILD_CHANNEL_LIST
BOOLEAN Set_Ieee80211dClientMode_Proc(RTMP_ADAPTER *pAd, PSTRING arg);
#endif /* EXT_BUILD_CHANNEL_LIST */

BOOLEAN Show_Adhoc_MacTable_Proc(RTMP_ADAPTER *pAd, PSTRING extra, UINT32 size);
...
BOOLEAN Set_BeaconLostTime_Proc(RTMP_ADAPTER *pAd, PSTRING arg);
BOOLEAN Set_AutoRoaming_Proc(RTMP_ADAPTER *pAd, PSTRING arg);
BOOLEAN Set_SiteSurvey_Proc(RTMP_ADAPTER *pAd, PSTRING arg);
BOOLEAN Set_ForceTxBurst_Proc(RTMP_ADAPTER *pAd, PSTRING arg);
...
//JB removed VOID dump_txinfo(RTMP_ADAPTER *pAd, TXINFO_STRUC *pTxInfo);
VOID dump_rxinfo(RTMP_ADAPTER *pAd, RXINFO_STRUC *pRxInfo);
//JB removedVOID dump_rxblk(RTMP_ADAPTER *pAd, RX_BLK *pRxBlk);
