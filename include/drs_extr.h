...
//jb removed extern UCHAR RateSwitchTable11B[];
//jb removed extern UCHAR RateSwitchTable11G[];
//jb removed extern UCHAR RateSwitchTable11BG[];
...
BOOLEAN Set_RateTable_Proc(
	IN  struct _RTMP_ADAPTER *pAd,
	IN  PSTRING arg);
#endif /*NEW_RATE_ADAPT_SUPPORT*/

#ifdef AGS_SUPPORT
BOOLEAN Show_AGS_Proc(
