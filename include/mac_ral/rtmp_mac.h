...
BOOLEAN rtmp_mac_set_band(struct _RTMP_ADAPTER *pAd, int  band);
BOOLEAN rtmp_mac_set_ctrlch(struct _RTMP_ADAPTER *pAd, UINT8 extch);
BOOLEAN rtmp_mac_set_mmps(struct  _RTMP_ADAPTER *pAd, int ReduceCorePower);

void rtmp_mac_bcn_buf_init(struct _RTMP_ADAPTER *pAd);

BOOLEAN rtmp_mac_init(struct _RTMP_ADAPTER *pAd);

#ifdef MCS_LUT_SUPPORT
BOOLEAN set_lut_phy_rate(struct _RTMP_ADAPTER *pAd, UINT8 wcid, UINT8 mcs,
	UINT8 bw, UINT8 gi, UINT8 stbc, UINT8 mode);
#endif /* MCS_LUT_SUPPORT */
